...
|---|---|---|---|---|
| **Overview** | Propuesta de solución móvil para que una organización contratante supervise servicios de limpieza tercerizada B2B. Su idea central es relacionar el contrato con obligaciones, ejecución, evidencia, evaluación de cumplimiento, inconformidades y acciones correctivas. El alcance inicial se concentra en Lima Metropolitana. | Plataforma chilena de gestión de servicios no operacionales y facility management. Permite controlar servicios ejecutados por equipos propios o contratistas, incluyendo limpieza, aseo industrial, seguridad y mantención menor. | Plataforma especializada en inspecciones de limpieza, mantenimiento y calidad de instalaciones. Centraliza formularios, calificaciones, fotografías, tickets, acciones correctivas y reportes para equipos de facilities, proveedores y clientes. | Plataforma de facility management para organizaciones con múltiples ubicaciones. Centraliza órdenes de trabajo, proveedores, mantenimiento, cumplimiento, analítica y documentación en un sistema compartido. |
| **Ventaja competitiva / valor ofrecido** | Enfoque en demostrar el cumplimiento de un servicio contratado. La evidencia se vincula con una obligación, ubicación, criterio de aceptación y respuesta ante una desviación. La propuesta busca ser más acotada y accesible para organizaciones que todavía trabajan con canales dispersos. | Es el competidor más cercano al modelo de dos lados. Su propuesta permite que contratistas registren actividades y que los encargados de instalaciones monitoreen el proceso en línea. También comunica control de incidentes, trazabilidad y reportería. | Profundidad en control de calidad de limpieza. Ofrece checklists configurables, inspecciones móviles offline, fotografías con fecha y GPS, tickets de deficiencias, alertas y reportes compartibles con clientes. | Amplitud para administrar proveedores y operaciones de facilities en múltiples sedes. Permite controlar desempeño, órdenes de trabajo, costos, documentación, cumplimiento y comunicación con proveedores. |
| **Mercado objetivo** | Organizaciones que contratan servicios de limpieza tercerizada, inicialmente pequeñas y medianas empresas con una o varias instalaciones. Sus usuarios principales son supervisores o responsables del servicio de la empresa contratante y operarios de la empresa prestadora que registran evidencias. | Empresas y áreas de servicios generales, facility management y operaciones que necesitan controlar servicios propios o tercerizados. Su presencia pública se concentra en Chile, aunque comunica una expansión hacia otros mercados. | Building service contractors, universidades, centros educativos, hospitales, aeropuertos, municipios y equipos de gestión de propiedades o instalaciones. | Marcas y operadores multiubicación de sectores como retail, restaurantes, supermercados, hoteles, educación y salud. Los usuarios incluyen equipos de facilities, personal de sede, responsables corporativos y proveedores externos. |
| **Estrategia de marketing** | La estrategia preliminar consiste en validar el problema con empresas contratantes y prestadoras, demostrar un flujo concreto de trazabilidad y comunicar resultados como menor tiempo de consolidación, mayor visibilidad y detección temprana de desviaciones. | Se posiciona como una solución para dejar de operar a ciegas y conocer si los proveedores cumplen lo comprometido. Utiliza demostraciones, casos de clientes y una comunicación centrada en control remoto, eficiencia y datos para la toma de decisiones. | Comunica simplicidad, rápida adopción y control de calidad basado en datos. Utiliza prueba gratuita, demostraciones, contenido especializado y casos de instituciones que comparten sus resultados con clientes y equipos internos. | Se posiciona como una plataforma empresarial para mejorar la experiencia en cada sede, reducir costos y obtener visibilidad sobre proveedores. Utiliza demostraciones, casos de grandes marcas y una red propia de proveedores. |
| **Productos y servicios** | Aplicación móvil para que los operarios consulten actividades, registren ejecuciones y adjunten evidencias. Los supervisores podrán revisar el cumplimiento, registrar observaciones, gestionar no conformidades, dar seguimiento a acciones correctivas y consultar reportes e historial. | Registro de actividades mediante QR, monitoreo en línea, gestión de incidentes, notificaciones, reportería y seguimiento de servicios de limpieza y mantención. La información pública también menciona herramientas para colaboradores, contratistas, jefaturas y clientes. | Formularios y checklists, inspecciones offline, calificaciones, fotos, notas, GPS, tickets, asignación de acciones correctivas, alertas, programación, dashboards y reportes automáticos. Cuenta con aplicación móvil y acceso web. | Órdenes de trabajo, mantenimiento preventivo, gestión de proveedores, control de desempeño, cumplimiento y riesgos, analítica, archivos, facturación y aplicación móvil para proveedores. Los proveedores pueden revisar órdenes, registrar avances y adjuntar fotografías. |
| **Precios y costos** | Se ofrecen dos planes desde S/300 por la supervision de 10 personales de limpieza y S/900 por mas de 10 personales de limpieza | No publica una tarifa estándar en sus páginas consultadas y orienta la contratación hacia el contacto comercial y la demostración. El costo dependería del alcance, servicios, sedes y usuarios. | Publica planes desde US$250 mensuales para 2 inspectores y US$500 mensuales para 10 inspectores. También ofrece cotización para equipos grandes y un módulo adicional de validación del servicio. | No publica una tarifa estándar y orienta la venta hacia una demostración. Por su cobertura de proveedores, sedes, órdenes, analítica y cumplimiento, se observa una orientación principalmente empresarial. |
| **Canales de distribución** | Aplicación móvil para operarios y supervisores, respaldada por Landing Page para realizar la conversion de usuarios. La distribución inicial debería realizarse mediante pilotos con organizaciones contratantes y sus proveedores de limpieza en Lima. | Plataforma web y herramientas móviles para el personal que ejecuta servicios en terreno y los responsables que monitorean instalaciones. La venta se realiza mediante contacto y demostración directa. | Aplicación móvil para iOS y Android, plataforma web, prueba gratuita y demostraciones. Puede desplegarse en instalaciones de clientes, equipos de inspección y proveedores de servicios. | Plataforma web para operadores multiubicación y aplicación móvil para proveedores y personal en campo. La contratación se realiza mediante contacto comercial, demostraciones y configuración por organización. |
| **Fortalezas** | Enfoque específico en la relación entre contrato, obligación, ejecución, evidencia, cumplimiento y acción correctiva. Modelo de dos lados que conecta al supervisor de la organización contratante con el operario del proveedor. | Coincide directamente con el modelo de supervisar servicios ejecutados por contratistas o equipos propios. Incluye limpieza, registro mediante QR, monitoreo en línea, incidentes, reportes y trazabilidad. Tiene una propuesta regional en español y experiencia comunicada en facility management. | Alta especialización en inspecciones de limpieza y calidad de instalaciones. Checklists configurables, modo offline, fotografías, GPS, tickets, acciones correctivas, programación y reportes. Cuenta con experiencia en sectores como educación, salud, aeropuertos y facility management. | Plataforma consolidada para organizaciones multiubicación. Integra órdenes de trabajo, proveedores, desempeño, cumplimiento, documentación, analítica y una aplicación para que los proveedores registren avances y fotografías. Permite construir un historial compartido entre la organización y sus contratistas.|
| **Debilidades** | Startup sin posicionamiento comercial ni cartera de clientes. Producto todavía en etapa de validación. Recursos limitados frente a plataformas establecidas. Falta definir y probar el modelo de precios, los permisos entre organizaciones, las reglas de evidencia y el nivel de integración necesario. | La información pública no evidencia una adaptación específica al mercado peruano. Su propuesta cubre varios servicios, por lo que puede ser menos especializada en la relación entre cláusulas, obligaciones y criterios de aceptación de un contrato de limpieza. La contratación depende del contacto comercial. | El precio público se relaciona con la cantidad de inspectores y puede ser elevado para organizaciones pequeñas. Su centro de gravedad está en inspecciones y control de calidad, no en administrar el ciclo contractual completo. La información pública está principalmente orientada al mercado angloparlante. | Su orientación es amplia y empresarial, con funciones de mantenimiento, costos, activos y proveedores que pueden exceder el problema actual. No está especializada únicamente en limpieza. La información pública indica una contratación mediante demostración y no muestra una tarifa estándar. |
| **Oportunidades** | Digitalización de la supervisión de servicios tercerizados en Lima. Necesidad de reducir el uso disperso de WhatsApp, Excel y papel. Espacio para una solución en español adaptada a procesos locales. Posibilidad de extender el modelo a seguridad, mantenimiento u otros servicios después de validar limpieza. | Expansión hacia nuevos países latinoamericanos. Mayor demanda de control remoto y datos sobre servicios críticos. Posibilidad de fortalecer reportes, automatización y servicios para organizaciones con múltiples instalaciones. | Crecimiento de la demanda por evidencias de calidad, auditorías y transparencia con clientes. Integración con áreas de facilities, proveedores y responsables de instalaciones. Aplicación de estándares de limpieza y reportes comparables entre sedes. | Empresas con muchas sedes que necesitan estandarizar proveedores, controlar niveles de servicio y consolidar información. Integración con procurement, facilities, finanzas y auditoría. Mayor demanda de trazabilidad y control de terceros. |
| **Amenazas** | Competidores con mayor experiencia, reputación y cobertura funcional. Resistencia de proveedores a transparentar su operación. Dificultad para lograr la adopción simultánea del cliente y del proveedor. Riesgo de que las organizaciones continúen usando herramientas genéricas de bajo costo. | ServiceChannel y otras plataformas empresariales pueden competir con mayor profundidad. OrangeQC puede resultar más especializado en inspecciones de limpieza. Soluciones genéricas de formularios o canales informales pueden mantener un menor costo inicial. | eGenya ofrece una propuesta regional más cercana al español y a servicios tercerizados. ServiceChannel ofrece una plataforma más amplia para proveedores y sedes. Herramientas de inspección general pueden competir por precio y simplicidad. | Soluciones verticales de limpieza pueden ser más sencillas y económicas. eGenya puede tener mayor cercanía regional. La complejidad de implementación y la dependencia de que los proveedores adopten la plataforma pueden retrasar la obtención de valor. |
